...
import 'package:helloworld/widgets/card_conteudo.dart';
...
class ListaConteudo extends StatefulWidget {
  ...
  const ListaConteudo({
    ...
    required this.conteudo5,
    required this.conteudo6,
    required this.conteudo7,
    required this.conteudo8,
    required this.conteudo9,
